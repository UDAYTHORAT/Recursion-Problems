public class Tower_of_Hanoi
{
	...
	{
		if(n==1){
			System.out.println("Move disk "+n+" from  "+ Source +" to "+ Destination);// #base case
			return;
		}

		Hanoi(n-1,Source,Destination,Helper);//#1
		System.out.println("Move disk "+n+" from  "+ Source +" to "+ Destination);//#2
		Hanoi(n-1,Helper,Source,Destination);//#3
